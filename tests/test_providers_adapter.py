...
class TestAlibabaCloudAdapter(unittest.TestCase):
    ...
    def test_update_cdn_certificate(self, mock_renew_cert):
    ...
    def test_update_load_balancer_certificate(self, mock_renew_cert):
    ...
    def test_get_current_cdn_certificate(self, mock_get_cert):
